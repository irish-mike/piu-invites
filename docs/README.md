...
| [Testing standards](testing-standards.md) | How to select and maintain useful tests; registration has schema and HTTP boundary tests alongside lint, types, builds, and browser inspection. |
