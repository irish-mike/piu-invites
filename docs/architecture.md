...
- A centred amber prize callout, “BEST COSTUME WINS 60€”, sits with the event details above the registration form so it is visible before scrolling. The quiet attribution footer follows the collage without another CTA.
